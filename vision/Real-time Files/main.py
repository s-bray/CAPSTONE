...
size=300
#/home/poisonarrow/vision-test/pothole-detection-system-using-convolution-neural-networks/Real-time Files
 ## load Training data : pothole
potholeTrainImages = glob.glob("/home/poisonarrow/vision-test/pothole-and-plain-rode-images/My Dataset/train/Pothole/*.jpg")
potholeTrainImages.extend(glob.glob("home/poisonarrow/vision-test/pothole-and-plain-rode-images/My Dataset/train/Pothole/*.jpeg"))
potholeTrainImages.extend(glob.glob("home/poisonarrow/vision-test/pothole-and-plain-rode-images/My Dataset/train/Pothole/*.png"))
...
nonPotholeTrainImages = glob.glob("home/poisonarrow/vision-test/pothole-and-plain-rode-images/My Dataset/train/Plain/*.jpg")
...
nonPotholeTestImages = glob.glob("home/poisonarrow/vision-test/pothole-and-plain-rode-images/My Dataset/test/Plain/*.jpg")
# nonPotholeTrainImages.extend(glob.glob("C:/Users/anant/Desktop/pothole-and-plain-rode-images/My Dataset/train/Plain/*.jpeg"))
# nonPotholeTrainImages.extend(glob.glob("C:/Users/anant/Desktop/pothole-and-plain-rode-images/My Dataset/train/Plain/*.png"))
...
potholeTestImages = glob.glob("home/poisonarrow/vision-test/pothole-and-plain-rode-images/My Dataset/test/Pothole/*.jpg")
# nonPotholeTrainImages.extend(glob.glob("C:/Users/anant/Desktop/pothole-and-plain-rode-images/My Dataset/train/Plain/*.jpeg"))
# nonPotholeTrainImages.extend(glob.glob("C:/Users/anant/Desktop/pothole-and-plain-rode-images/My Dataset/train/Plain/*.png"))
